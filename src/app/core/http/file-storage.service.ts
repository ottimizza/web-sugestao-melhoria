...
export class FileStorageService {
  ...
  constructor(private http: HttpHandlerService, private authorizationService: AuthenticationService) { }
  ...
  public store(file: any): Observable<GenericResponse<any>> {
    ...
    return this.http.post<GenericResponse<any>>(url, formData, 'Falha ao enviar arquivo', { headers });
  }
